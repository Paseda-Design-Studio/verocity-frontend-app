	...
	<section class="relative overflow-hidden bg-gray-50 py-10 sm:py-24">
		<div class="container">
			<div class="max-w-3xl mx-auto">
				...
				<!-- filter -->
				<div class="filter flex justify-between mb-6">
					<!-- first column -->
					<div class="flex gap-2 items-center">
						<span class="text-sm text-[#344054] font-medium">Filter</span>
						<InputText
					...
					<div class="flex">
						<IconField>
							...
							<InputText placeholder="Enter Tracking ID" />
						</IconField>
					</div>
				</div>

				<div
					class="content flex flex-col border border-gray-300 bg-white rounded-lg p-6"
				>
					<ShipmentCard
						v-for="(item, index) in listItems"
						:key="index"
						:track-i-d="item.trackID"
