...
<template>
  <div class="min-h-screen bg-gray-100 text-gray-900 flex justify-center">
    <div class="w-full m-0 bg-gray-100 shadow sm:rounded-lg flex gap-10 items-center justify-center flex-1 p-16">
      <div class="max-w-lg flex-1 mt-8 flex bg-white py-12 px-10 flex-col relative rounded-lg shadow-md">
        <AuthBackArrow />
        <!-- Success state -->
        <div v-if="verificationSuccess" class="flex flex-col items-center gap-4">
          ...
          <Button @click="authStore.isAdmin ? navigateTo('/admin/dashboard') : navigateTo('/user/welcome')"
        ...
        <div v-else class="flex flex-col items-center">
          ...
          <div v-if="message" class="text-green-600 text-center mb-4 p-2 bg-green-50 rounded w-full">
            {{ message }}
          </div>

          <div v-if="error" class="text-red-600 text-center mb-4 p-2 bg-red-50 rounded w-full">
            {{ error }}
          </div>
          ...
          <div class="w-full mb-6">
            <div class="flex flex-col items-center gap-4">
              <!-- OTP Input -->
              <InputOtp v-model="otp" :length="4" integerOnly />
              <Button @click="verifyOtp" :loading="loading"
              ...
              <div class="text-center mt-4">
                <p class="text-sm text-gray-600">
                  ...
                  <span @click="returnToLogin" class="p-button-link cursor-pointer text-primary-600 p-0 underline">
                    Return to login
                  </span>
                </p>
              </div>
